#ifndef PERIODICHASH_HP
#define PERIODICHASH_HP
  ...
  c -= a; c -= b; c ^= (b>>22); \
    ...
    public:
        ...
        static uint32_t BOBHash32(const uint8_t* str, uint32_t len, uint32_t num){
            ...
            c = primep[num];         /* the previous hash value */
    ...
    template<typename T>
    inline uint32_t periodichash(T data, uint32_t seed = 0){
